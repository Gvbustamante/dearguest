...
export default function AdminPlans() {
  ...
  return (
    <div className="admin-panel">
      ...
      <p className="admin-hint">Los cambios se reflejan en el sitio público (paquetes, calculadora, tabla comparativa) al guardar.</p>
      ...
      <div className="admin-plans-grid">
        {plans.map((plan) => (
          <div className="admin-plan-card" key={plan.id}>
            ...
            <div className="cf-field">
              <label>Insignia (ej. "La favorita de las mamás")</label>
              <input value={plan.badge ?? ""} onChange={(e) => updateField(plan.id, "badge", e.target.value)} />
            </div>
            <div className="cf-field">
              <label>Link de pago (Wompi)</label>
              <input value={plan.wompi_url} onChange={(e) => updateField(plan.id, "wompi_url", e.target.value)} />
            </div>
            <div className="cf-field">
